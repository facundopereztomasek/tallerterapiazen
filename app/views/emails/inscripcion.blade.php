<!DOCTYPE html>
<html lang="en" style="font-family: sans-serif;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
<head>
	<meta charset="UTF-8">
	<title>Inscripci&oacute;n al taller</title>
	<style>
...
<body style="margin: 0;padding: 20px 0;background: #333333;">
	<div class="wrapper" style="width: 640px;background-color: #e5d4c6;background-image: url(<?php echo $message->embed('images/background.jpg'); ?>);margin: 0 auto;border-right: 2px solid #303030;border-bottom: 2px solid #303030;">
		<div class="header screen-only" style="background-color: #151515;overflow: auto;">
			<span class="info" style="color: #bbbbbb;font-family: &quot;Tahoma&quot; Sans-Serif;font-weight: 100;font-size: 14px;display: block;float: none;margin-left: 5px;padding: 10px;margin: 0;">e-mail generado autom&aacute;ticamente. Por favor no responda a este e-mail.</span>
		</div>
