					...
					<article class="workshop-view">
						...
						<div class="row">
							...
							<div class="col-xs-4 col-md-4">
								<ul class="data">
									<li><strong class="data-type">Fecha</strong><span class="data-info">Sábado 22 de Agosto de 2015</span></li>
							...
							<div class="col-xs-8 col-md-8">
								...
								<ul class="activity-list">
									...
									<li class="activity">
										...
										<span class="activity-name">¿Qué es la mente? Ilusiones mentales ¿Hay que confiar en nuestra mente?</span>
									</li>
									<li class="activity">
							...
							<div class="col-xs-8 col-md-8">
								...
								<ul class="activity-list">
									<li class="activity">
										...
										<span class="activity-name">¿Por qué sufrimos? Condicionamientos mentales Distorsiones cognitivas ¿Cómo salir de la “Matrix”?</span>
									</li>
									<li class="activity">
									...
									<li class="activity">
										...
										<span class="activity-name">Final del 1<sup>er</sup> encuentro.</span>
									</li>
								</ul>
							</div>
						</div>
							...
							<div class="col-xs-8 col-md-8">
								<div class="contents">
									<p class="paragraph">Recordá: <br>
										El dia 22 te esperamos en lo posible a partir de 09.15, 
	...
	<div class="modal taller-modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			...
			{{ Form::open( array('route'=>'inscribirse_taller','class'=>'modal-form clearfix')) }}
				...
				<div class="input-container"><input type="hidden" name="taller" value="1"></div>
