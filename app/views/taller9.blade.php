				...
				<div class="col-xs-12 col-md-12">
					...
					<article class="workshop-view">
						<header class="workshop-header bg-taller-2">
							<h1 class="title">Taller Psicolog&iacute;a de la compasi&oacute;n y pr&aacute;cticas de meditaci&oacute;n <br> 4<sup>to</sup> encuentro: Teoria de la mente, asertividad, empatía: recursos para <br>la práctica de la compasión.</h1>
							<button type="button" class="btn btn-primary" data-toggle="modal" data-target=".taller-modal">Inscribirse</button>
						</header>
						<div class="row">
							<div class="col-xs-8 col-md-8">
								<div class="contents">
									<p class="paragraph phrase">"La paz viene del interior. No la busques fuera. Somos formados por nuestros pensamientos; nos convertimos en lo que pensamos. Cuando la mente es pura, la alegría le sigue como una sombra que nunca se va."</p>
							...
							<div class="col-xs-4 col-md-4">
								<ul class="data">
									<li><strong class="data-type">Fecha</strong><span class="data-info">Sábado 28 de Noviembre de 2015</span></li>
									<li><strong class="data-type">Hora</strong><span class="data-info">09.30 hs. a 13.30 hs.</span></li>
							...
							<div class="col-xs-8 col-md-8">
								...
								<ul class="activity-list">
									...
									<li class="activity">
										...
										<span class="activity-name">Desarrollo de recursos psicológicos.</span>
									</li>
									<li class="activity">
						...
						<div class="row">
							<div class="col-xs-8 col-md-8">
								...
								<ul class="activity-list">
									<li class="activity">
										<span class="hours">11</span><span class="colon">:</span><span class="minutes">15</span>
										<span class="activity-name">Práctica de la Compasión ¿Cómo reforzar tu mente ante la frustración y la agresividad?</span>
									</li>
									<li class="activity">
									...
									<li class="activity">
										...
										<span class="activity-name">Puesta en común. Final del 4<sup>to</sup> encuentro.</span>
									</li>
								</ul>
							</div>
						</div>
							...
							<div class="col-xs-8 col-md-8">
								<div class="contents">
									<p class="paragraph">Recordá: <br>
										El dia 29 te esperamos en lo posible a partir de 09.15, 
									...
									<p class="paragraph">
										(*) si te anotás para realizar todos los encuentros podés pagar hasta el 28 de Agosto por adelantado el total del Taller $1350 por los 4 encuentros.</p>
	...
	<div class="modal taller-modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<div class="title-container">
					<p class="title">Taller: Psicolog&iacute;a de la compasi&oacute;n y pr&aacute;cticas de meditaci&oacute;n <br> 4<sup>to</sup> encuentro.</p>
				</div>
			{{ Form::open( array('route'=>'inscribirse_taller','class'=>'modal-form clearfix')) }}
				<p class="subtitle">Formulario de contacto</p>
				<div class="input-container"><input type="hidden" name="taller" value="9"></div>
