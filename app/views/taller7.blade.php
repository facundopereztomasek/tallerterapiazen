				...
				<div class="col-xs-12 col-md-12">
					...
					<article class="workshop-view">
						<header class="workshop-header bg-taller-2">
							<h1 class="title">Taller psicolog&iacute;a de la compasi&oacute;n y pr&aacute;cticas de meditaci&oacute;n <br> 2<sup>do</sup> encuentro: Psicología y compasión. Beneficios en tu autoestima.</h1>
						...
						<div class="row">
							...
							<div class="col-xs-4 col-md-4">
								<ul class="data">
									<li><strong class="data-type">Fecha</strong><span class="data-info">Sábado 26 de Septiembre de 2015</span></li>
							...
							<div class="col-xs-8 col-md-8">
								...
								<ul class="activity-list">
									...
									<li class="activity">
										...
										<span class="activity-name">Psicología basada en el Zen y Compasión.</span>
									</li>
									<li class="activity">
							...
							<div class="col-xs-8 col-md-8">
								...
								<ul class="activity-list">
									<li class="activity">
										...
										<span class="activity-name">¿Por qué ayudar hace bien? Compasión y beneficios en la autoestima.</span>
									</li>
									<li class="activity">
									...
									<li class="activity">
										...
										<span class="activity-name">Puesta en común. Final del 2<sup>do</sup> encuentro.</span>
									</li>
								</ul>
							</div>
						</div>
							...
							<div class="col-xs-8 col-md-8">
								<div class="contents">
									<p class="paragraph">Recordá: <br>
										El dia 26 te esperamos en lo posible a partir de 09.15, 
	...
	<div class="modal taller-modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<div class="title-container">
					<p class="title">Taller: psicolog&iacute;a de la compasi&oacute;n y pr&aacute;cticas de meditaci&oacute;n <br> 2<sup>do</sup> encuentro.</p>
				</div>
			{{ Form::open( array('route'=>'inscribirse_taller','class'=>'modal-form clearfix')) }}
				<p class="subtitle">Formulario de contacto</p>
				<div class="input-container"><input type="hidden" name="taller" value="7"></div>
