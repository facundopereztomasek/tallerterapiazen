					...
					<article class="workshop-view">
						...
						<div class="row">
							<div class="col-xs-8 col-md-8">
								<div class="contents">
									<p class="paragraph">"Pronto el silencio será una leyenda del pasado. El hombre inventa, día tras día, máquinas y dispositivos que aumentan el ruido y distraen a la humanidad de la esencia de la vida, de la contemplación, de la meditación."</p>
							...
							<div class="col-xs-4 col-md-4">
								<ul class="data">
									<li><strong class="data-type">Fecha</strong><span class="data-info">Sábado 25 de Abril de 2015</span></li>
							...
							<div class="col-xs-8 col-md-8">
								<div class="contents">
									<p class="paragraph">Recordá: <br>
										El dia 25 te esperamos en lo posible a partir de 09.15, 
									...
									<p class="paragraph">
										(*) si te anotás para realizar todos los encuentros podés pagar hasta el 24 de Abril por adelantado el total del Taller con el 14% de descuento: $1200 por los 4 encuentros.</p>
